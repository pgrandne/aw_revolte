...
library Game {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "done";
    _fieldNames[1] = "number";
    _fieldNames[2] = "nft";
    _fieldNames[3] = "content";
  ...
  /** Get number */
  function getNumber(bytes32 key) internal view returns (uint256 number) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get number (using the specified store) */
  function getNumber(IStore _store, bytes32 key) internal view returns (uint256 number) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set number */
  function setNumber(bytes32 key, uint256 number) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((number)));
  }

  /** Set number (using the specified store) */
  function setNumber(IStore _store, bytes32 key, uint256 number) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((number)));
  }

  /** Get nft */
  function getNft(bytes32 key) internal view returns (string memory nft) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get nft (using the specified store) */
  function getNft(IStore _store, bytes32 key) internal view returns (string memory nft) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set nft */
  function setNft(bytes32 key, string memory nft) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    StoreSwitch.setField(_tableId, _keyTuple, 2, bytes((nft)));
  }

  /** Set nft (using the specified store) */
  function setNft(IStore _store, bytes32 key, string memory nft) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    _store.setField(_tableId, _keyTuple, 2, bytes((nft)));
  }

  /** Get the length of nft */
  function lengthNft(bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get the length of nft (using the specified store) */
  function lengthNft(IStore _store, bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get an item of nft (unchecked, returns invalid data if index overflows) */
  function getItemNft(bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get an item of nft (using the specified store) (unchecked, returns invalid data if index overflows) */
  function getItemNft(IStore _store, bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Push a slice to nft */
  function pushNft(bytes32 key, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Push a slice to nft (using the specified store) */
  function pushNft(IStore _store, bytes32 key, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Pop a slice from nft */
  function popNft(bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Pop a slice from nft (using the specified store) */
  function popNft(IStore _store, bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Update a slice of nft at `_index` */
  function updateNft(bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Update a slice of nft (using the specified store) at `_index` */
  function updateNft(IStore _store, bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setContent(bytes32 key, string memory content) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 3, bytes((content)));
  }
  ...
  function setContent(IStore _store, bytes32 key, string memory content) internal {
    ...
    _store.setField(_tableId, _keyTuple, 3, bytes((content)));
  }
  ...
  function set(bytes32 key, bool done, uint256 number, string memory nft, string memory content) internal {
    bytes memory _data = encode(done, number, nft, content);
  ...
  function set(bytes32 key, GameData memory _table) internal {
    set(key, _table.done, _table.number, _table.nft, _table.content);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, GameData memory _table) internal {
    set(_store, key, _table.done, _table.number, _table.nft, _table.content);
  }
  ...
  function decode(bytes memory _blob) internal view returns (GameData memory _table) {
    ...
    _table.number = (uint256(Bytes.slice32(_blob, 1)));
    ...
    if (_blob.length > 33) {
      ...
      _table.nft = (string(SliceLib.getSubslice(_blob, _start, _end).toBytes()));
  ...
  function encode(
    ...
    _counters[0] = uint40(bytes(nft).length);
    _counters[1] = uint40(bytes(content).length);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(done, number, _encodedLengths.unwrap(), bytes((nft)), bytes((content)));
  }
